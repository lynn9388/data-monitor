...
public class AppLog {
    ...
    private App app;
    private Integer app__resolvedKey;
    ...
    public AppLog(Long id, java.util.Date time, int uid, long sendBytes, long receiveBytes, String networkType) {
        this.id = id;
        this.time = time;
        this.uid = uid;
